...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getGithubAccounts = function (term) {
        if (term === void 0) { term = ''; }
        if (term) {
            return this.http.get("https://api.github.com/search/users?q=" + term).pipe(operators_1.map(function (rsp) { return rsp.items; }));
        }
        else {
            return rxjs_1.of([]);
        }
    ...
    DataService.prototype.getPeople = function (term) {
        ...
        return rxjs_1.of(items).pipe(operators_1.delay(500));
    };
